...
/**
 * Summary. Outlines features of the product in a tabbed display.
 *
 * Description. A tab display that showcases three major features of the Bookmark product: Simple, Speedy, and Easy.
 */
  ...
  return (
    <Tab.Panel>
      <div className="flex flex-col lg:flex-row items-center">
        ...
        <div className="flex flex-col flex-1 items-center justify-center lg:items-start text-center lg:text-left pt-16 md:pt-0 md:pl-16 lg:pl-28">
